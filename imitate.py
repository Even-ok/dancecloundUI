...
def photo_score(ns,camera=True,pose=False,del_all=True,duration=3,imitate_video_path=None):
    ...
    if imitate_video_path==None:
        ...
        create_path(root=rootpath+'imitate_jsons/'+ns+'/',file_name=imitate_name)
            ...
            if event.type == pygame.QUIT:
                ...
                if event.button == 1:
                    ...
                    if 150<x<295 and 10<y<60:#点击输入视频名称
                        ...
                        score,name_score,rhythm_score=photo_score(ns=name[:-4],camera=False,pose=True,duration=duration,imitate_video_path=test_path)
